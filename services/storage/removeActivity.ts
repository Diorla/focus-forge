...
// The reason why I am using deletedAt instead of just deleting the file is because
// of synching with the web. If I merge two data/json, the deleted object will reappear
// in the app.
